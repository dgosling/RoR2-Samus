...
namespace SamusMod.Modules
{
    internal static class ItemDisplays
    {
        ...
        internal static void InitItemDisplays()
        {
            ...
            var samusRules = Prefabs.bodyPrefabs[0].GetComponentInChildren<CharacterModel>().itemDisplayRuleSet;
            samusRules.keyAssetRuleGroups = CreateItemDisplaySamus();
            samusRules.GenerateRuntimeValues();
            // Survivor 2 code goes here...
        }
        private static ItemDisplayRuleSet.KeyAssetRuleGroup[] CreateItemDisplaySamus()
        {
