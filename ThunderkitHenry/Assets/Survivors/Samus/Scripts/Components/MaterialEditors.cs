...
namespace SamusMod.Components
{
    ...
    public class MaterialControllerComponents
    {
        public static void SetShaderKeywordBasedOnBool(bool enabled, Material material, string keyword)
        {
            if (!material)
            {
                SamusPlugin.logger.LogError($"Material field was null, cannot run shader keyword method.");
                return;
            }
        ...
        public class HGControllerFinder : MonoBehaviour
        {
            ...
            public void Start()
            {
                //SamusPlugin.logger.LogMessage("Getting Renderer");
                Renderer = gameObject.GetComponent<Renderer>();
                //SamusPlugin.logger.LogMessage("found " + Renderer);
                if (Renderer)
                {
                ...
                //else
                //    SamusPlugin.logger.LogError("Couldn't find renderer!");
                Destroy(this);
            }
        }
